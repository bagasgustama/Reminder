...
require_once("include/custom_personal_agenda_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "custom_personal_agenda" );
