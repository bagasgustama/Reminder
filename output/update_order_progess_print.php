...
require_once("include/update_order_progess_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "update_order_progess" );
