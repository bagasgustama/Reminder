...
require_once("include/custom_group_product_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "custom_group_product" );
