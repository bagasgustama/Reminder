...
require_once("include/custom_group_member_agenda_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "custom_group_member_agenda" );
