...
require_once("include/group_member_agenda_subscriber_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "group_member_agenda_subscriber" );
