...
require_once("include/group_operation_off_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "group_operation_off" );
