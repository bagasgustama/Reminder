...
require_once("include/group_agenda_general_logs_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "group_agenda_general_logs" );
