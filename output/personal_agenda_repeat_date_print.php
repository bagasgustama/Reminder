...
require_once("include/personal_agenda_repeat_date_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "personal_agenda_repeat_date" );
