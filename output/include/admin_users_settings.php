...
$tdataadmin_users[".OriginalTable"] = "personal";
...
if(mlang_getcurrentlang()=="English")
{
	...
	$fieldLabelsadmin_users["English"]["member_id"] = "Member Id";
	$fieldToolTipsadmin_users["English"]["member_id"] = "";
	$placeHoldersadmin_users["English"]["member_id"] = "";
	$fieldLabelsadmin_users["English"]["name"] = "Name";
	$fieldToolTipsadmin_users["English"]["name"] = "";
	$placeHoldersadmin_users["English"]["name"] = "";
	$fieldLabelsadmin_users["English"]["mail"] = "Mail";
	$fieldToolTipsadmin_users["English"]["mail"] = "";
	$placeHoldersadmin_users["English"]["mail"] = "";
	...
	$fieldLabelsadmin_users["English"]["country_id"] = "Country Id";
	$fieldToolTipsadmin_users["English"]["country_id"] = "";
	$placeHoldersadmin_users["English"]["country_id"] = "";
	$fieldLabelsadmin_users["English"]["province_id"] = "Province Id";
	$fieldToolTipsadmin_users["English"]["province_id"] = "";
	$placeHoldersadmin_users["English"]["province_id"] = "";
...
$tdataadmin_users[".connId"] = "notif_basic1_at_localhost";


$tdataadmin_users[".strOriginalTableName"] = "personal";
...
$tdataadmin_users[".googleLikeFields"][] = "member_id";
$tdataadmin_users[".googleLikeFields"][] = "name";
$tdataadmin_users[".googleLikeFields"][] = "mail";
$tdataadmin_users[".googleLikeFields"][] = "password";
$tdataadmin_users[".googleLikeFields"][] = "country_id";
$tdataadmin_users[".googleLikeFields"][] = "province_id";
...
$tdataadmin_users[".sqlHead"] = "SELECT member_id,  	name,  	mail,  	password,  	country_id,  	province_id";
$tdataadmin_users[".sqlFrom"] = "FROM personal";
...
$tableKeysadmin_users[] = "member_id";
...
//	Custom field settings
	...
	$fdata["Label"] = GetFieldLabel("admin_users","member_id");
	$fdata["FieldType"] = 20;
...
//end of Filters settings
	...
	$tdataadmin_users["member_id"] = $fdata;
		$tdataadmin_users[".searchableFields"][] = "member_id";
//	name
//	Custom field settings
	$fdata = array();
	$fdata["Index"] = 2;
...
//	Custom field settings
	...
	$fdata["GoodName"] = "mail";
	$fdata["ownerTable"] = "personal";
	$fdata["Label"] = GetFieldLabel("admin_users","mail");
	$fdata["FieldType"] = 200;
...
//end of Filters settings
	...
	$tdataadmin_users["mail"] = $fdata;
		$tdataadmin_users[".searchableFields"][] = "mail";
//	password
//	Custom field settings
	$fdata = array();
	$fdata["Index"] = 4;
...
//end of Filters settings
	...
	$tdataadmin_users["country_id"] = $fdata;
		$tdataadmin_users[".searchableFields"][] = "country_id";
//	province_id
//	Custom field settings
	$fdata = array();
	$fdata["Index"] = 6;
	...
	$fdata["ownerTable"] = "personal";
	$fdata["Label"] = GetFieldLabel("admin_users","province_id");
	$fdata["FieldType"] = 20;
...
//end of Filters settings
	...
	$tdataadmin_users["province_id"] = $fdata;
		$tdataadmin_users[".searchableFields"][] = "province_id";
