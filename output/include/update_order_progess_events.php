 ...
 */
 ...
 class eventclass_update_order_progess  extends eventsBase
{
...
$data = array();
$data["group_product_id"] = $oldvalues['group_product_id'];
...
$msg = "Pesanan " . $product_name . " sejumlah " . $oldvalues['quantity'] . 
				" dari transaksi order " . $group . " dengan id " . $oldvalues['group_member_order_id'] . " sudah selesai diprogres.";
