...
require_once("include/group_agenda_type11_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "group_agenda_type11" );
